...
\paragraph{MISRA C}
%
MISRA-C hat seinen Ursprung in der Automobilindustrie. Er wurde durch die britische \glqq The Motor Industry Sofrware Reliability Association \grqq eingeführt, um den ersten Standard für die Programmiersprache C zu definieren. Letzterer wurde in 1998 veröffentlich. Seitdem sind 2 weitere Ausgaben mit Verbesserungen und Ergänzungen zu den alten erfolgt.

Beim MISRA-C-Standard sind eine Vielzahl an Regeln veröffentlicht, um robusteren und zuverlässigeren C-Code für Steuergeräte zu produzieren. Desweiteren wird damit erreicht, dass die erstellten Softwarekomponenten wiederverwendbar und portabler sind.

Die PES-Abteilung hat sich somit das Ziel gesetzt, die Anwendung der aktuellen MISRA-Standards in ihre Produktionslinien zu gewährleisten. 

Die MISRA-Version, die bisher bei PES bzw. bei der Vector GmbH eingesetzt wird, bezieht sich auf die \glqq MISRA-C:2004 guidelines for the use of the C language in critical systems \grqq. Eine neue Version ist im Jahr 2012 verabschiedet worden. Diese beinhaltet ausführliche Änderungen und Anpassungen.

Auf Aufgrund der Tatsache, dass C keine sichere Programmierung von Software gewährleistet, wird seit mehreren Jahren  bei Vector Informatik der C-Programmierstandard  MISRA-C: 2004 eingesetzt.
