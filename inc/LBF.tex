\chapter{Erste Aufgabe: MISRA- und QA-C-Analyse zum Umstieg auf neue Versionen}
%
\section{Erste Woche}
%
...
%
\chapter{Zweite Aufgabe: BTE auf Hardware}
%
...
\end{figure}%
%
\subsection*{Verwendeter Lösungsansatz}\label{Ansaetze}
%
...
\begin{figure}[!htp]
\centering
\includegraphics[scale=0.7]{./Bilder/Protocol2.pdf}
...
\section{Elfte Woche}
%
\subsection*{Dekodierung und Rekonstruktion eines XML-Testreports}
%
...
\begin{figure}[!htp]
\centering
\includegraphics[scale=0.8]{./Bilder/StateMaschPERL_cropped.pdf}
...
%
\subsection*{Gesamte Struktur des erweiterten Anwendungfalls}
%
...
%\end{landscape}
%
\subsection{Validierung und Ergebnisse der 2. Aufgabenstellung}
%
...
\begin{figure}[!htp]
\centering
\includegraphics[scale=0.55]{./Bilder/reports.pdf}
