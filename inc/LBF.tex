...
\begin{figure}[!htp]
\centering
\includegraphics[angle=90,scale=0.55]{./Bilder/QAC7_9Zusam.pdf}
\caption{QAC}
...
In \figvref{fig:EPICskr1} wird sowohl der erste erstellte PERL-Skript als auch die genannte EPIC-IDE gezeigt. Mithilfe des erstellten Skripts war es möglich, die oben beschriebene Aufgabe zu lösen. Der komplette Skript wird im Anhang \ref{cha:tools} angegeben.

%
\begin{figure}[!htp]
\centering
\includegraphics[scale=0.45]{./Bilder/EPIC_skr1.pdf}
\caption{EPICskr1}
\label{fig:EPICskr1}
\end{figure}
