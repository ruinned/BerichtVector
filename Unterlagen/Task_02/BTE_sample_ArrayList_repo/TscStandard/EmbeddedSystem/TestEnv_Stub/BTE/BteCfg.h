...
#define kBteEventList_size 50

#define NOTUSE_HARDWARE

#if defined (USE_HARDWARE)
#define USE_INTERNAL_LOG
#define NOTUSE_PRINTF
#define LATER
#define BTE_DISABLE_TIME_MEASUREMENT
#define BTE_DISABLE_TESTREPORT
#define BTE_DISABLE_TRACEREPORT
#define BTE_ENABLE_EVENTLIST
#define BTE_DISABLE_EVENTCALLCONTEXTLIST
#define BTE_DISABLE_EVENTTIMINGLIST
#define BTE_DISABLE_CALLCONTEXT
#define BTE_DISABLE_CRITICALSECTION
