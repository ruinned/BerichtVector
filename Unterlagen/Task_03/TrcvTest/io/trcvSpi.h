...
/* Service functions */
extern void trcvSpi_InitMemory(void);
extern void trcvSpi_Init(void);
extern uint16 trcvSpi_writeWord(uint16 data, uint8 device);
extern void trcvSpi_up(void);
extern void trcvSpi_down(void);
